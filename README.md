...
**RAGWorker**（RAG综合智能体）是一个基于 **Spring Boot 3** + **React 18** 构建的企业级智能文档处理与检索问答系统。系统深度融合了 RAG（检索增强生成）技术，支持多通道检索、意图识别、会话记忆、深度思考等高级功能，为企业提供精准、可溯源的知识问答服务。
